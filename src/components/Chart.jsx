...
//     useEffect(
//       ()=>{
//         const updateChartDetails=async()=>{
//           const {days,weeks,months,years}=chartConfig[filter];
//           const endDate=new Date();
//           const StartDate=createDate(endDate,-days,-weeks,-months,-years);
//           try{
//           const fromDate=convertDateToUnixTimestamp(StartDate)
//           const today=convertDateToUnixTimestamp(endDate)
// console.log(fromDate);
// console.log(today);
// const resolution=chartConfig[filter].resolution;
// console.log("Stock:",stockSymbol)
// const result=await fetchHistoricalData(stockSymbol,resolution,fromDate,today);
// console.log(result);
// setData(result);
//           }
//           catch(error){
